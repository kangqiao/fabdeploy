...
BOOL_True = ['True', 'true', 'TRUE', '1', True, 1]
BOOL_False = ['False', 'false', 'FALSE', '0', False, 0]
BOOL_LIST = BOOL_True + BOOL_False
...
def test_configuration(verbose=True):
    ...
    elif not env.nginx_https in BOOL_LIST: # or not isinstance(env.nginx_https, bool)
